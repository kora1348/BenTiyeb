...
function fetchDataForPeriod() {
  const startDate = document.getElementById("startDate").value; // Format : "YYYY-MM-DDTHH:MM"
  const endDate = document.getElementById("endDate").value; // Format : "YYYY-MM-DDTHH:MM"
