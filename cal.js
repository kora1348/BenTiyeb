function calculerPrixCrypto() {
    ...
    document.getElementById("result1").innerText = "Résultat après +4% : " + prixApresAugmentationQuatrePourcent.toFixed(10)  + " => 3";
    ...
    document.getElementById("result2").innerText = "Résultat après +8% : " + prixApresAugmentationHuitPourcent.toFixed(10)  + " => 6";
    ...
    document.getElementById("result3").innerText = "Résultat après +12% : " + prixApresAugmentationDouzePourcent.toFixed(10)  + " => 9";
    ...
    document.getElementById("result4").innerText = "Résultat après +16% : " + prixApresAugmentationSeizePourcent.toFixed(10)  + " => 18";
    ...
    document.getElementById("result5").innerText = "Résultat après +20% : " + prixApresAugmentationVingtPourcent.toFixed(10)  + " => 36*";
    ...
    document.getElementById("result6").innerHTML = "Résultat après -4% : <span class='blue'>" + prixApresReductionQuatrePourcent.toFixed(10) + "</span> => 3";
    ...
    document.getElementById("result7").innerText = "Résultat après -8% : " + prixApresReductionHuitPourcent.toFixed(10) + " => 6";
    ...
    document.getElementById("result8").innerText = "Résultat après -12% : " + prixApresReductionDouzePourcent.toFixed(10) + " => 9";
    ...
    document.getElementById("result9").innerText = "Résultat après -16% : " + prixApresReductionSeizePourcent.toFixed(10) + " => 18";
    ...
    document.getElementById("result10").innerText = "Résultat après -20% : " + prixApresReductionVingtPourcent.toFixed(10) + " => 36";
}
