async function fetchCryptoData(symbol) {
    try {
        const response = await fetch(`https://api.binance.com/api/v3/klines?symbol=${symbol}USDT&interval=3d&limit=2`);
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            const daysVariation = ((closePrice - openPrice) / openPrice) * 100;
