async function fetchCryptoData(symbol) {
  try {
      ...
      if (totalVariation >= -170 && totalVariation <= -160) {
  ...
  fetchCryptoData("BNBDOWN");
  fetchCryptoData("BNBUP");
  fetchCryptoData("BTCDOWN");
  fetchCryptoData("BTCUP");
  fetchCryptoData("ETHDOWN");
  fetchCryptoData("ETHUP");
