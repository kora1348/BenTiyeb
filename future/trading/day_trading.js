async function fetchCryptoData(symbol) {
  try {
      ...
      if ((totalVariation >= 5.00 && totalVariation <= 5.99) || (totalVariation >= 10.00 && totalVariation <= 11.99)) {
          totalCell.classList.add("positive");
          cryptoNamesElement.innerHTML += `<p id="${symbol}_status" class="positive">${symbol}: LONG, ${totalValue}%</p>`;
      } 
      
      if ((totalVariation <= -5.99 && totalVariation >= -5.00) || (totalVariation <= -10.99 && totalVariation >= -10.00) ) {
