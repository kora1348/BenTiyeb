  const symbols = [   "BTC",
   "1INCH",
    ...
    async function fetchCryptoData(symbol) {
      const res = await fetch(`https://api.binance.com/api/v3/klines?symbol=${symbol}USDT&interval=1d&limit=10`);
    ...
    async function generateMatrix() {
      ...
      // Alertes
      document.getElementById("alertBox").innerText = alerts.length > 0
        ? alerts.join('\n')
